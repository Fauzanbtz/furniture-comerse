  ...
  return (
    <div>
      ...
      <div className="md:flex justify-between p-10 px-5 pt-10 md:px-24 items-center">
        ...
        <div className="md:w-1/2 bg-primary flex flex-col gap-5 justify-center items-center p-8 mt-10 md:mt-0 rounded-3xl">
          ...
          <form action="" className="flex flex-col gap-3 w-full">
            ...
            <div className="flex w-full bg-secondary justify-center rounded-full">
              <button className=" text-white p-3 rounded-3xl">Submit</button>
            </div>
          </form>
        </div>
      </div>
